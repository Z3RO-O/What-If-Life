...
export default function Layout({ children }: LayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Simulate', href: '/simulate', current: location.pathname === '/simulate', requiresAuth: true },
  ];
            ...
            <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
              ...
              {isAuthenticated ? (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56 glass border-gray-700 backdrop-blur-xl" align="end" forceMount>
                    <div className="flex items-center justify-start gap-2 p-3">
                      <div className="flex flex-col space-y-1 leading-none">
                        <p className="font-accent-light text-white">{user?.profile?.full_name || 'User'}</p>
