  ...
  const freemiumFeatures = [
    {
      ...
      description: 'Analyze life decisions with quantum AI to see potential outcomes and alternate paths with remarkable precision.',
      color: 'text-blue-400',
    },
    {
      icon: Users,
      title: 'Community Insights',
      description: 'Learn from anonymized patterns of similar decisions made by our global community of visionaries.',
      color: 'text-emerald-400',
    },
    {
      icon: Shield,
      title: 'Privacy Protection',
      description: 'Military-grade encryption ensures your personal data is never shared with third parties or compromised.',
      color: 'text-purple-400',
    },
    {
      icon: BarChart3,
      title: 'Timeline Visualization',
      description: 'View interactive timeline projections of your alternate life paths in stunning detail and clarity.',
      color: 'text-pink-400',
    }
  ];
  ...
  const premiumFeatures = [
    {
      ...
      description: 'Deep analysis of career trajectories with salary projections, growth paths, and industry insights.',
      color: 'text-orange-400',
    },
    {
      icon: Heart,
      title: 'Relationship Analysis',
      description: 'Understand how decisions affect relationships, social connections, and emotional well-being.',
      color: 'text-pink-400',
    },
    {
      icon: Calendar,
      title: 'Life Mapping',
      description: 'Comprehensive life event predictions with precise timing, probabilities, and impact analysis.',
      color: 'text-blue-400',
    },
    {
      icon: Sparkles,
      title: 'AI Media Generation',
      description: 'Generate photorealistic images and videos of your alternate life scenarios with quantum precision.',
      color: 'text-purple-400',
    }
  ];
      ...
      <div className="container-wide relative">
        <div className="text-center mb-20 lg:mb-28 content-center">
          <div className="inline-flex items-center space-x-3 glass rounded-full px-8 py-4 mb-12 lg:mb-16 white-glow">
            ...
            <span className="text-white font-accent text-base lg:text-lg">REVOLUTIONARY FEATURES</span>
          ...
          <p className="text-large text-gray-300 content-center font-accent-light leading-relaxed">
            Begin your journey with powerful free features, then unlock advanced capabilities when you're ready to explore deeper realities.
          </p>
        </div>
              ...
              >
                <CardContent className="card-content-comfortable">
                  <div className="relative mb-8 lg:mb-10">
                    <feature.icon className={`h-14 w-14 lg:h-16 lg:w-16 xl:h-20 xl:w-20 ${feature.color} group-hover:scale-110 transition-transform animate-float`} />
                  ...
                  <h3 className="text-xl lg:text-2xl xl:text-3xl font-accent text-white mb-6 lg:mb-8">{feature.title}</h3>
                  <p className="text-gray-300 text-base lg:text-lg xl:text-xl leading-relaxed mb-6 lg:mb-8">{feature.description}</p>
        ...
        <div className="text-center content-center">
          <div className="accent-card rounded-3xl p-12 lg:p-16 xl:p-20 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h3 className="text-3xl lg:text-4xl xl:text-5xl font-accent text-white mb-8 lg:mb-12">READY TO UNLOCK EVERYTHING?</h3>
              <p className="text-gray-300 mb-12 lg:mb-16 text-xl lg:text-2xl xl:text-3xl font-accent-light content-center leading-relaxed">
                Start with our revolutionary free features, then upgrade to premium for the complete multiverse experience.
              </p>
